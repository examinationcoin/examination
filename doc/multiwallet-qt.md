...
Only requiring some minor changes is examination.cpp.
...
Changes to examination.cpp
----------------------
examination.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
