...
#if defined(NDEBUG)
# error "Examination cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Examination Signed Message:\n";
...
{
    int64_t ret = blockValue*0.85; // start at 50%
...
void ThreadScriptCheck() {
    RenameThread("examination-scriptch");
