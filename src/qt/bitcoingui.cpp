    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Examination Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Examination address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and examination: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Examination Core"), this);
    aboutAction->setStatusTip(tr("Show information about Examination Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Examination"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Examination addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Examination addresses"));
    ...
    openAction->setStatusTip(tr("Open a examination: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Examination Core help message to get a list with possible Examination command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Examination Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Examination network", "", count));
}
...
{
    QString strTitle = tr("Examination Core"); // default title
