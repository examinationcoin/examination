...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Examination Core"),
     ...
     * override -datadir in the examination.conf file in the default data directory
     * (to be consistent with examinationd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
