...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::EXAM);
    ...
    if (settings.contains("nAnonymizeDarkcoinAmount"))
        SoftSetArg("-anonymizeexaminationamount", settings.value("nAnonymizeDarkcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in examination.cpp during shotdown to also remove the window positions
