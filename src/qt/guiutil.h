...
/** Utility functions used by the Examination Qt UI.
 */
namespace GUIUtil
{
    ...
    // Render Examination addresses in monospace font
    ...
    // Parse "examination:" URI into recipient object, return true on successful parsing
