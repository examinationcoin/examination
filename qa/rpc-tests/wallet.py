...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 EXAM, node2 has none. 
#   d) node0 sends 21 EXAM to node2, in two transactions (11 EXAM, then 10 EXAM).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 EXAM from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 EXAM in block rewards plus fees, but
