...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 EXAM:
        ...
        # Node0's balance should be starting balance, plus 500 EXAM for another
        ...
        # Node0's total balance should be starting balance, plus 1000 EXAM for 
